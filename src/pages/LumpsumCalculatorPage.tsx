  ...
  export default function LumpsumCalculatorPage() {
    return (
      <Box>
        ...
        >
          Use this Lumpsum Investment Calculator to estimate how much your
          one-time investment can grow over time. Enter your investment amount,
          expected annual return and time period to see the total value and wealth
          created.
        </Typography>
        ...
        <Box sx={{ mt: 6, mb: 4 }}>
          ...
          <Accordion disableGutters>
            <AccordionSummary
              ...
              aria-controls="lumpsum-faq-1-content"
              id="lumpsum-faq-1-header"
            >
          ...
          <Accordion disableGutters>
            <AccordionSummary
              expandIcon={<ExpandMoreIcon />}
              aria-controls="lumpsum-faq-2-content"
              id="lumpsum-faq-2-header"
            >
              <Typography variant="body2" fontWeight={500}>
          ...
          <Accordion disableGutters>
            <AccordionSummary
              expandIcon={<ExpandMoreIcon />}
              aria-controls="lumpsum-faq-3-content"
              id="lumpsum-faq-3-header"
            >
              <Typography variant="body2" fontWeight={500}>
